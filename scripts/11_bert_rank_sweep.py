#!/usr/bin/env python3
"""
BERT-base Rank Sweep on SNLI (Seed 42)
=======================================
Sweep over LoRA ranks {1, 2, 4, 8, 16, 32} with BERT-base-uncased on SNLI
to validate the monotonic rank-correlation relationship beyond RoBERTa.

Follows the exact same pattern as 03_rank_sweep.py but uses bert-base-uncased.

Usage:
    python scripts/11_bert_rank_sweep.py
    python scripts/11_bert_rank_sweep.py --ranks 1 2 4 8 16 32
    python scripts/11_bert_rank_sweep.py --no-skip-existing
"""
